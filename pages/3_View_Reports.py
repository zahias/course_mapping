...
try:
    ...
    # silently ignore if no file on Drive or error
    pass

per_student_assignments = load_assignments(csv_path=csv_path_for_major)
...
if reset_btn:
    # This will remove the CSV on Drive and local DB
