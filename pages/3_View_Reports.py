...
if 'raw_df' not in st.session_state:
    ...
    if target_courses is None or intensive_courses is None:
        ...
        # Create export copies (untoggled) for report generation
        export_required_df = required_courses_df.copy()
        export_intensive_df = intensive_courses_df.copy()
        ...
        # Create a copy for on-screen display toggling
        ...
        # Show the toggled display on-screen
        ...
        # For export, use the untoggled (export) copies to preserve full grade strings for proper color formatting.
        config_for_formatting = target_courses.copy()
        config_for_formatting.update(intensive_courses)
        output = save_report_with_formatting(export_required_df, export_intensive_df, timestamp, config_for_formatting)
